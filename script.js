...
// grabbing usefull elemetns from DOM
var ball = document.getElementById('ball');
var rod1 = document.getElementById('rod1');
var rod2 = document.getElementById('rod2');

// PPName = PlayerName
// PPMaxScore = PlayerMaxScore
...
(function () {
    ...
    if (rod === "null" || maxScore === "null") {
        ...
        alert(storeName + " has maximum score of " + maxScore * 100);
    }
...
function resetBoard(rodName) {
    // calculating the space available in left side and right side from the rods
    ...
    if (event.code === "Enter") {
        ...
        if (!gameOn) {
            ...
            movement = setInterval(function () {
                ...
                rod1 = rod1.getBoundingClientRect().x;
                rod2 = rod2.getBoundingClientRect().x;
                ...
                if (ballY <= rod1Height) {
                    ...
                    if ((ballPos < rod1) || (ballPos > (rod1 + rod1Width))) {
                ...
                // Check for Rod 2
                    ...
                    // Check if the game ends
                    if ((ballPos < rod2) || (ballPos > (rod2 + rod2Width))) {
